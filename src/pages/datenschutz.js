...
const DatenschutzPage = () => (
  <Layout>
    ...
    <p>
      <span>E-Mail: kontakt@mokkapps.de</span>
    </p>
    ...
    <p>
      Die Einwilligung in den Newsletter-Versand können Sie gemäß Art. 7 Abs. 3
      DSGVO jederzeit mit Wirkung für die Zukunft widerrufen. Hierzu müssen Sie
      uns lediglich über Ihren Widerruf in Kenntnis setzen oder den in jedem
      Newsletter enthaltenen Abmeldelink betätigen.
    </p>
    ...
    <h4>Analytics</h4>
    <p>
      Nutzungs- und nutzerbezogene Informationen, wie bspw. Browser, Betriebssystem, Ort,
      Zeit oder Häufigkeit des Besuchs unseres Internetauftritts, werden
      an einen eigenen Server in Deutschland übertragen und dort gespeichert.
    </p>
